...
5.  **Typography & Branding:** Used custom fonts (`Playfair Display` and `Montserrat`) to establish a clear visual brand identity.

## Technologies Used
* **HTML5** (Semantic Structure)
* **CSS3** (Flexbox, Grid Layout, Custom Properties/Variables)
* **RWD** (Responsive Web Design - implicitly ready for media queries)

## How to View the Project
To view the site, simply clone the repository and open the `index.html` file in your web browser.


Developed by Alessio Ghelli
